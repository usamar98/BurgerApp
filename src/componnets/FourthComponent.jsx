  ...
  return (
    ...
    <div  className="container shadow my-5 ">
      <div className="row px-3 py-3 event">
        <div className="col-lg-6  my-3 col-xs-12  position-relative">
          ...
          <div className="buttons d-flex position-absolute">
          <span class="p-2  rounded-circle "></span>
          <span class="p-2   rounded-circle active"></span>
          <span class="p-2  rounded-circle "></span>
          </div>
        </div>
        <div className="col-lg-6  my-3 col-xs-12  position-relative d-flex overflow-hidden burger-img">
